...
- **2.0.1 Reporting Bootstrap/Setup**  
  • Kind: `infra`  
  • Depends on: `1.x`  
  • Expected outputs: `/Users/b/DATA/PROJECTS/Telco/Level_3/resources/reports/section2, /Users/b/DATA/PROJECTS/Telco/Level_3/resources/reports/section2/section2_data_quality_20251112_214755.csv`
- **2.0.2 Config & Constants Registration**  
  • Kind: `infra`  
  • Depends on: `2.0.1`  
  • Expected outputs: `/Users/b/DATA/PROJECTS/Telco/Level_3/resources/reports/section2/section2_config_checks.csv`
...
- **2.0.4 Dataset Ingestion & Preview**  
  • Kind: `overview`  
  • Depends on: `1.5`  
  • Expected outputs: `/Users/b/DATA/PROJECTS/Telco/Level_3/resources/reports/section2/dataset_overview.csv`
- **2.0.5 Row/Column Baseline Summary**  
  • Kind: `overview`  
  • Depends on: `2.0.4`  
  • Expected outputs: `/Users/b/DATA/PROJECTS/Telco/Level_3/resources/reports/section2/baseline_summary.csv`
